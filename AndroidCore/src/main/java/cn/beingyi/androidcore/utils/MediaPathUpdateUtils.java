 ...
 * on 2020/5/16
 **/
public class MediaPathUpdateUtils {

    Activity activity;

    public MediaPathUpdateUtils(Activity activity) {
    ...
    public void udpateMedia(String url){
        ...
        File file=new File(url);
        ContentResolver localContentResolver = activity.getContentResolver();
        ContentValues localContentValues = getImageContentValues(activity, file,      System.currentTimeMillis());
